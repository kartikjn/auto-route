import {
  ...
  export type ContractContext = EthersContractContextV5<
    PancakeswapFactory,
    PancakeswapFactoryMethodNames,
    PancakeswapFactoryEventsContext,
    PancakeswapFactoryEvents
  >;
  ...
  export type PancakeswapFactoryEvents = 'PairCreated';
  export interface PancakeswapFactoryEventsContext {
    PairCreated(...parameters: any): EventFilter;
  }
  export type PancakeswapFactoryMethodNames =
    | 'new'
    | 'allPairs'
    | 'allPairsLength'
    | 'createPair'
    ...
    | 'setFeeTo'
    | 'setFeeToSetter';
  export interface PancakeswapFactory {
    /**
     * Payable: false
     * Constant: false
