import {
  ...
  export type ContractContext = EthersContractContextV5<
    PancakeswapPair,
    PancakeswapPairMethodNames,
    PancakeswapPairEventsContext,
    PancakeswapPairEvents
  >;
  ...
  export type PancakeswapPairEvents = 'PairCreated';
  export interface PancakeswapPairEventsContext {
    PairCreated(...parameters: any): EventFilter;
  }
  export type PancakeswapPairMethodNames =
    | 'new'
    | 'allPairs'
    | 'allPairsLength'
    | 'createPair'
